...
class ImageCaptioner(BaseTransform):
    ...
    def transform(
        ...
        for chunk in chunks:
            ...
            for img_id in referenced_ids:
                ...
                if caption:
                    captions_to_add[img_id_stripped] = caption
            ...
            if captions_to_add:
                ...
                merged: Dict[str, str] = {}
                merged.update(self._normalize_image_captions(existing))
                merged.update(captions_to_add)
                chunk.metadata["image_captions"] = merged
    ...
    def _normalize_image_captions(raw: Any) -> Dict[str, str]:
        """Normalize chunk metadata.image_captions to dict[image_id, caption].

        Supports the canonical dict form and a legacy list-of-dict form.
        """

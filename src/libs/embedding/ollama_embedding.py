...
class OllamaEmbedding(BaseEmbedding):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Keep prompts short enough for the local Ollama embedding model.
        self.max_input_chars = max_input_chars or self.DEFAULT_MAX_INPUT_CHARS
        ...
        **kwargs: Any,
        ...
        for text in texts:
            if len(text) > self.max_input_chars:
                logger.warning(
                    "Truncating Ollama embedding input from %d to %d characters",
                    len(text),

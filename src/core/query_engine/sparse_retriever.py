...
class SparseRetriever:
    ...
    Example:
        ...
        >>> bm25_indexer = BM25Indexer(index_dir="/runtime/bm25")
...
def create_sparse_retriever(
    ...
    Args:
        ...
        index_dir: Optional explicit directory for BM25 index files.
            If omitted, derived from the configured vector-store root.
    ...
    if bm25_indexer is None:
        from src.ingestion.storage.bm25_indexer import BM25Indexer
        effective_index_dir = index_dir or str(get_bm25_index_dir("default", settings))
        bm25_indexer = BM25Indexer(index_dir=effective_index_dir)

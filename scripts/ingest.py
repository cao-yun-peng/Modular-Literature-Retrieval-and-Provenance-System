...
Usage:
    ...
    # Process papers with enhanced metadata extraction (title, authors, DOI, sections, figures, tables)
    python scripts/ingest.py --path papers/ --collection research_papers --paper-loader
...
def main() -> int:
    ...
    print(f"   Paper Loader: {args.paper_loader}")

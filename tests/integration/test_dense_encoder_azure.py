...
def azure_embedding(settings):
    ...
    """
    # Skip if not using Azure embedding provider
    if settings.embedding.provider != "azure":
        pytest.skip(f"Azure embedding provider required, got '{settings.embedding.provider}'")
...
def test_azure_configuration_is_valid(settings):
    ...
    """
    if settings.embedding.provider != "azure":
        pytest.skip(f"Azure provider required, got '{settings.embedding.provider}'")

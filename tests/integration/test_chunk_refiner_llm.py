...
def test_multiple_providers_if_available(provider, env_var, sample_noisy_chunk):
    ...
    if provider == "ollama" and refined_chunk.metadata.get("refined_by") != "llm":
        pytest.skip("Ollama provider is reachable but not producing LLM output in this environment")

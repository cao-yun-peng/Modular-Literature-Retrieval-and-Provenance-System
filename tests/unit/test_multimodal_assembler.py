...
def test_extract_image_refs_supports_legacy_list_image_captions(assembler: MultimodalAssembler):
    """Legacy compatibility: image_captions may be stored as list-of-dict."""
    result = RetrievalResult(
        ...
        metadata={
            ...
            "image_captions": [{"id": "img1", "caption": "Legacy caption"}],
        },
    )
    ...
    assert refs[0].caption == "Legacy caption"
